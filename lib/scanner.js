...
function selectScanTargets(group) {
  if (group.startsWith("crypto-core")) return { cryptoAssets: CONFIG.scanGroups[group] ?? CONFIG.scanGroups["crypto-core"], futuresAssets: [], tradfiAssets: [] };
  if (group.startsWith("crypto-alt")) return { cryptoAssets: CONFIG.scanGroups[group] ?? CONFIG.scanGroups["crypto-alt"], futuresAssets: [], tradfiAssets: [] };
