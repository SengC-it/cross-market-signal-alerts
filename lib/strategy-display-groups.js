...
export const STRATEGY_DISPLAY_GROUPS = Object.freeze([
  ...
  Object.freeze({ id: "v4_forward", key: "v4Forward", label: "V4 FORWARD", order: 20 }),
  Object.freeze({ id: "v4_shadow", key: "v4Shadow", label: "V4 SHADOW", order: 30 }),
  Object.freeze({
  ...
  Object.freeze({ id: "v3_4_forward_paper", key: "v34ForwardPaper", label: "V3.4 FORWARD PAPER", order: 50 }),
  Object.freeze({ id: "v3_3_forward_paper", key: "v33ForwardPaper", label: "V3.3 FORWARD PAPER", order: 60 }),
  Object.freeze({ id: "v3_1_forward_paper", key: "v31ForwardPaper", label: "V3.1 FORWARD PAPER", order: 70 }),
  Object.freeze({ id: "legacy_production", key: "legacyProduction", label: "LEGACY PRODUCTION", order: 80 })
]);
...
export function strategyGroupForSignal(signal = {}) {
  ...
  if (
    ...
    && !isV4ShadowSignal(signal, modelVersion, strategyId)
    && !isShadowOnly(signal)
  ) {
    return GROUP_BY_ID.get(
      signalVariant === "STRONG_EXTENSION_10_15" ? "v4_2_forward" : "v4_forward"
    );
  }
  ...
  if (isShadowOnly(signal)) return null;
...
function isV4ShadowSignal(signal, modelVersion, strategyId) {
  if (modelVersion !== V42_MODEL_ID) return false;
  if (strategyId === V42_SHADOW_STRATEGY_ID) return true;
  return isShadowOnly(signal) && !strategyId;
}
