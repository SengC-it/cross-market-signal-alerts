...
function finishedReview(outcome, decision, entryExecution, reviewedAt, plan, executionModel, exchangeFilters) {
  const exitExecution = resolveExitExecution({
    decision,
    side: plan.side,
    executionModel,
    exchangeFilters
  ...
  return {
    status: "reviewed",
    outcome,
    exitPrice: exitExecution.marketPrice,
    ...
    rawExitMarketPrice: exitExecution.rawMarketPrice,
    exitFillPrice: exitExecution.fillPrice,
